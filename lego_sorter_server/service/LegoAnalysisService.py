...
class LegoAnalysisService(LegoAnalysis_pb2_grpc.LegoAnalysisServicer):
    ...
    def DetectBricks(self, request: ImageRequest, context):
        logger.info("[LegoAnalysisService] Request received, processing...")
        ...
        logger.info(f"[LegoAnalysisService] Detecting and preparing response took {elapsed_millis} milliseconds.")
    ...
    def DetectAndClassifyBricks(self, request: ImageRequest, context):
        ...
        logger.info(f"[LegoAnalysisService] Detecting, classifying and preparing response took "
