...
class LegoAnalysisFastRunner:
    ...
    def __init__(self, processing_queue: ImageProcessingQueueFast, hub_connection: HubConnectionBuilder):
    ...
    def __process_next_image(self, save_cropped_image, save_label_file):
        image, lego_class = self.processing_queue.next(CAPTURE_TAG)
