...
from lego_sorter_server.analysis.classification.classifiers.TinyViTClassifier import TinyViTClassifier
...
class LegoClassifierProvider:
    ...
    def get_default_classifier() -> LegoClassifier:
        if not LegoClassifierProvider.classifier:
            ...
            if not LegoClassifierProvider.classifier:
                LegoClassifierProvider.classifier = TinyViTClassifier()
